...
%% User inputs
file = 'P18_Audi_A1_Driving_Towards_30KPH_No_Slowing.wav';
...
%% Processing
[Detections_1, Detections_2, signal, threshold] = CA_CFAR_Detection(file, PFA, g_cells,Window_Size, index, cpi, overlapFactor);
