% Ferial Najaar
% NJRFER001 
% Main code for OSGO-CFAR algorithm

clear all;
close all;

%% User inputs
file = '12_AudiA1_P15_Driving_Towards_Fast_001.wav';
...
g_cells = 6;           % Guard Cells/2 for each side
Window_Size = 8;       % N/2
index = ceil((5/12)*(2*Window_Size));  


%% Processing
[Detections_1, Detections_2, signal, threshold] = OSGO_CFAR_Detection(file, PFA, g_cells,Window_Size, index, cpi, overlapFactor);
